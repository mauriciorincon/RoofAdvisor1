            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input maxlength="100" type="text" required="required" class="form-control"
                        ...
                        oninvalid="this.setCustomValidity('Please Enter First Name')" oninput="setCustomValidity('')"
                        value="<?php if(isset($_SESSION['post_info']['firstCustomerName'])){echo $_SESSION['post_info']['firstCustomerName']; } ?>" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input maxlength="100" type="email" required="required" class="form-control"
                        ...
                        onfocusout="validateEmail('customer')" oninvalid="this.setCustomValidity('Please Enter Email')"
                        oninput="setCustomValidity('')"
                        value="<?php if(isset($_SESSION['post_info']['emailValidation'])){echo $_SESSION['post_info']['emailValidation']; } ?>" />
                    <label class="control-label labeltwht" id="answerEmailValidate"
                ...
                <div class="form-group">
                    ...
                    <label class="control-label labeltwht" id="answerPasswordValidateStep6"
                        name="answerPasswordValidateStep6"></label>
                </div>
                <div class="form-group">
                    ...
                    <input maxlength="100" type="password" required="required" data-minlength="6"
                        ...
                        oninput="setCustomValidity('')" />
                    <label class="control-label labeltwht" id="answerRePasswordValidateStep6"
                        name="answerRePasswordValidateStep6"></label>
                </div>
                <div class="form-group">
                    ...
                    <input maxlength="100" type="number" min="1111111111" max="9999999999"
                        ...
                        oninvalid="this.setCustomValidity('Please Enter Phone Number, Phone must be of 10 digits ')"
                        oninput="setCustomValidity('')"
                ...
                <div class="form-group">
                    <label class="control-label labeltwht ">PLEASE READ THE TERMS THOROUGHLY AND CAREFULLY. BY USING THE
                    ...
                    <input type="checkbox" name="termsServiceAgree" id="termsServiceAgree" value="1"><span
                        style="color:white">I agree with the RoofServiceNow</span> <a
...
<div id="welcome-txt">
    <div class="mobiletxt1">
        <span>
            Need a <strong style="color:#fa511a">Roofer?</strong> Fast<strong style="color:#fa511a;"> same day</strong>
            service!
        </span>
    </div>
</div>
...
<div id="appwiz" class="">
    <div class="stepwizard">
        <div class="stepwizard-row setup-panelOrder">
            ...
            <div class="stepwizard-step col-xs-1">
                <a href="#step-10" type="button" class="btn btn-default btn-circle invisible"
                    disabled="disabled">2.1</a>
        ...
        <form role="form" align="left">
            <div id="step1contain">
                <div class="panel panel-primary setup-contentOrder panel-mv1" id="step-1">
                    ...
                    <div class="panel-body pbody-white">
                        <div class="form-group">
                            <label class="control-label text-center h4">If you need an Emergency Repair, Scheduled
                                Repair or Reroof/New Roof</label>
                            <label class="control-label text-center h3"><big>ZIP CODE</big></label>
                            <input maxlength="100" type="text" required="required" class="form-control input-lg"
                                placeholder="Enter your zip code" id="zipCodeBegin" name="zipCodeBegin" />
                            <label class="control-label text-center h1" id="answerZipCode"><big></big></label>
                        </div>

                        <button class="btn btn-primary nextBtnOrder pull-right" type="button" id="firstNextBegin"
                            name="firstNextBegin">Next</button>

                    </div>

                </div>
            </div>
            <button id="mainplaybtn1" class="btnvid1" disabled><a style="color:#fff;font-size:18px;"
                    href="video/roofpromo.mp4" data-lity><i style="margin-right:10px;" class="fas fa-play"></i>WATCH THE
                    VIDEO</a></button>
            <div id="roofreportbox1" class="panel-body roofbox1" align="left">
                <div class="list-group roofreportbox2">
                    <div class="panel-heading wizhead" style="color: #fff;"><strong>If you need to order a roof report.
                            Click Below!</strong></div>
                        ...
                        <table>
                            <tr>
                                <td style="padding: 12px 12px 12px 12px;">
                                    ...
                                    <button id="step2OtypeService3" class=" btn-primary   btn-lg" type="button"
                                        style="width:160px"  name="step2OtypeService">Order Roof Report</button>
									
                                </td>
                                <td style="padding: 12px 12px 12px 12px;">
                                    <h4 id="rrtxtbox1" style="text-align:justify;">Get a detailed roof report for $29
                                        within 2 hours. We create accurate aerial roof measurements and diagrams you can
                                        use to estimates material cost to replace your roof. If we cannot create the
                                        roof report for you due to aerial obstructions or roof complexity, we will
                                        refund your money guaranteed.<a
                                            href=<?php echo $_SESSION['rsn_documents_path']."SampleReport.pdf"; ?>
                                            style="color: #fa511a;" target="_blank"> See Sample </a> </h4>
                                </td>
                            </tr>
                        </table>
                        <div class="d-flex w-100 justify-content-between">
            ...
            <div class="panel panel-primary setup-contentOrder panel-mv1" id="step-2">
                <div class="panel-heading">
                    <h3 class="panel-title wizhead">
                        <font size="5"><strong>Select Service</strong></font>
                    </h3>
                </div>
                ...
                <div class="panel-body" align="left">
                    ...
                    <div class="list-group-item ">
                        <font size="5">&#9312;</font>
                        <font size="5"><strong>What type of service?</strong></font>
                    </div>
                    <div class="list-group">
                        <div class="form-group">
                        ...
                        <div class="list-group-item " name="linkServiceType" id="linkServiceTypeemergency">
                            <input type="hidden" value="emergency" name="typeServiceOrder">
                            <table>
                                <tr>
                                    <td style="padding: 12px 12px 12px 12px;">
                                        <button class=" btn-primary   btn-lg" type="button"
                                            style="width:160px" id="step2OtypeService"  name="step2OtypeService">Emergency Repair</button>
                                    </td>
                                    <td style="padding: 12px 12px 12px 12px;">
                                        <h4>An emergency repair is a same day service. The first available rated service
                                            pro will choose your repair order and provide you with an ETA of when they
                                            will arrive at the repair location. You will be able to review their
                                            ratings, communicate, send them pictures, and track their location. An
                                            estimate for your approval will be provided prior to start of work. </h4>
                                    </td>
                                </tr>
                            </table>
                            <div class="d-flex w-100 justify-content-between">
                        ...
                        <div class="list-group-item" name="linkServiceType" id="linkServiceTypeschedule">
                            <input type="hidden" value="schedule" name="typeServiceOrder">
                            <table>
                                <tr>
                                    <td style="padding: 12px 12px 12px 12px;">
                                        <button class=" btn-success   btn-lg" type="button" style="width:160px" id="step2OtypeService1"  name="step2OtypeService">Schedule
                                            Repair</button>
                                    </td>
                                    <td style="padding: 12px 12px 12px 12px;">
                                        <h4>A scheduled repair is scheduled a week in advance. You will be able to
                                            choose the service pro or allow the first available rated service pro will
                                            choose your repair order.</h4>
                                    </td>
                                </tr>
                            </table>
                            <div class="d-flex w-100 justify-content-between">
                        ...
                        <div class="list-group-item" name="linkServiceType" id="linkServiceTypereroof">
                            <input type="hidden" value="reroofnew" name="typeServiceOrder">
                            <table>
                                <tr>
                                    <td style="padding: 12px 12px 12px 12px;">
                                        <button class=" btn-primary   btn-lg" type="button" style="width:160px" id="step2OtypeService2" name="step2OtypeService">Re-roof
                                            or new Roof</button>
                                    </td>
                                    <td style="padding: 12px 12px 12px 12px;">
                                        <h4>Reroof or new roof estimates are scheduled a week in advance. Choose the
                                            qualified, pre-screened service professional from a list or allow the first
                                            top rated professional to choose your work order. You can chat and track
                                            your order. That easy!</h4>
                                    </td>
                                </tr>
                            </table>
                            <div class="d-flex w-100 justify-content-between">
				...
				<div class="list-group-item ">
                    ...
                    <button class="btn btn-primary nextBtnOrder pull-right" type="button">Next</button>
                    <button id="prev-step1-btn" class="btn btn-primary prevBtnOrder pull-left"
            ...
            <div class="panel panel-primary setup-contentOrder panel-mv1" id="step-10" align="left">
                <div class="panel-heading">
                    <h3 class="panel-title wizhead">
                        <font size="5"><strong>Answer Some Questions</strong></font>
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="list-group-item scr2fix">
                        <font size="5">&#9313;</font>
                        <font size="5"><strong>Select the type of roofing material on your property?</strong></font>
                    </div>
                    <div class="list-group-item scr2fix ">
                        <div class="form-group">
                    ...
                    <div class="list-group-item scr2fix">
                        <font size="5">&#9314;</font>
                        <font size="5"><strong>Are you aware of any leaks or damage to the roof?</strong></font>
                    </div>
                    ...
                    <div class="list-group-item scr2fix">
                        <font size="5">&#9315;</font>
                        <font size="5"><strong>How many stories is your home?</strong></font>
                    </div>
                    ...
                    <div class="list-group-item scr2fix">
                        <font size="5">&#9316;</font>
                        <font size="5"><strong>Are you the owner or authorized to make property changes?</strong></font>
                    </div>
            ...
            <div class="panel panel-primary setup-contentOrder panel-mv1" id="step-3" align="left">
                <div class="panel-heading">
                    <h1 class="panel-title wizhead">
                        <font size="5"><strong>Enter Service Location</strong></font>
                    </h1>
                </div>
                <div class="panel-body">
            ...
            <div class="panel panel-primary setup-contentOrder panel-mv1" id="step-4" align="left">
                <div class="panel-heading">
                    <h3 class="panel-title wizhead">
                        <font size="5"><strong>Select a Date & Time for service</strong></font>
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-2 col-xs-2 inpwiz1">
                            <span class="h1white">
                                <h4><b>Select the date of service. </b></h4>
                            </span><input type="text" id="step6date" name="step6date" class="datepicker"
                                style="font-size:24px;text-align:center;">
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-2 col-xs-2 inpwiz2">
                            <span class="h1white">
                                <h4><b>Select the time of service. </b></h4>
                            </span>
            ...
            <div class="panel panel-primary setup-contentOrder panel-mv1" id="step-5" align="left">
                <div class="panel-heading">
                    <h3 class="panel-title wizhead">
                        <font size="5"><strong>Contractor List</strong></font>
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <span class="h1white">
                            <h4><b>These Service Professionals are best suited for your scheduled repair and are all
                                    rated 4+ by previous customers.</b> </h4>
                        </span>
                        <!--</label>-->
                        <!--<label class="control-label" for="exampleRadios5">-->
            ...
            <div class="panel panel-primary setup-contentOrder panel-mv1" id="step-6" align="left">
                <div class="panel-heading">
                    <h1 class="panel-title wizhead">
                        <font size="5"><strong>Review Your Order Details</strong></font>
                    </h1>
                </div>
                <div class="panel-body">
            ...
            <div class="logbox1 panel panel-primary setup-contentOrder panel-mv1" id="step-7">
                ...
                <div class="panel-heading" style="display:none">
                    <h3 class="panel-title wizhead">
                        <font size="10"><strong>Customer information</strong></font>
                    </h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                            ...
                            <div class="list-group-item login-list1">
                                <div class="d-flex w-100 justify-content-between" style="z-index:1;">
                                    <div class="form-group">
                                        ...
                                        <input style="width:60%;color:#646363;" type="text" placeholder="Username"
                                            required="true" id="userClientOrder" name="userClientOrder" /><span
                                            class="required">&nbsp;&nbsp;*</span>
                                    </div>
                                    <div class="form-group">
                                        <label class="loglable"
                                            style="display: inline-block;margin-left: 73px;padding:3.1px 10px 3.1px 10px;"><i
                                                class="fa fa-key" aria-hidden="true" style="color:#fa511a"></i></label>
                                        <input style="width:60%;color:#646363;" type="password" placeholder="password"
                                            required="true" id="passwordClientOrder" name="passwordClientOrder" /><span
                                            class="required">&nbsp;&nbsp;*</span>
                                    </div>
                                    <div
                                        style="display:inline-block;text-align:left !important; position:absolute;left:200px;margin-top:-6px;">
                                        <a style="color:#fff;"
                                            href="index.php?controller=user&accion=resetPasswordCustomer">Forgot
                                            password?</a>
                                    </div>
                                    <br><br><br>
                                    <label style="display:none" id="answerValidateUserOrder"
                                ...
                                <table id="wizloginbtn1"  style="z-index: 5;position: relative;" class="logbox3">
                                    <tr>
                                        ...
                                        <td></td>
                                        <td><a style="margin-right:13px;" class="btn-primary btn-lg" data-toggle="modal"
                                                data-toggle1="tooltip" href="#"
                                        ...
                                        <td></td>
                                        <td>
                                            <h1 style="margin-right: 10px;" class="logintxtbtns1 labeltwht">or</h1>
                                        </td>
						...
						<td><button class="btn-primary btn-lg" type="button" id="button2" name="button2" onclick="login_customer_order_request()">register</button></td>-->
                                        ...
                                        <td><a class="btn-primary btn-lg" data-toggle="modal" data-toggle1="tooltip"
                                                href="#register-modal" onClick=""> register</a>
                                        </td>
                                    </tr>
                                </table>
                            <!--<button class="btn btn-primary nextBtnOrder pull-right" type="button">Next</button>-->
                        ...
                        <button class="btn btn-primary nextBtnCustomer pull-right" type="button"
                            id="lastFinishButtonOrder" name="lastFinishButtonOrder">Finish Order</button>
                    </div>
