<
		...
		<div class="service-area pt-80 pb-60">
			<div class="container">
                ...
                <p><b> Q. How much does RoofServiceNow cost?   </b> A. The price of our service requests varies by whether it’s an emergency on demand request or a scheduled repair request. To learn more, <a href="?controller=user&accion=dashboardCustomer">Log In</a>, and create your account today. </p>	
                <p><b> Q. How do I join?   </b><a href="?controller=user&accion=dashboardCustomer">Log In</a>, and create your account today</p>	
                </div>
			</div>
		</div>
        <!--  service-area end  -->			
