<?php
    ...
    foreach ($_array_customer as $key => $customer) {
			...
			$_string.='<a href="#" class="list-group-item " name="linkCustomer">
				<span class="glyphicon glyphicon-wrench"></span><input type="hidden" value="'.$customer['CustomerID'].'" name="idCustomer"> 
				<span name="customerName">'.$$_customerName.'</span><span class="badge badge-primary" style="background:black;" onclick="showRatings('.$_id_company.',)"></span>
