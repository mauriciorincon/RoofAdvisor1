...
<<<<<<< HEAD
	...
	<div id="page-content-wrapper">
		<div class="container-fluid">
			...
			<a href="#menu-toggle" class=" btn-secondary" id="menu-toggle">Show Actions</a>
				...
				<script>
					...
					function initMap() {
						...
						ref.orderByChild("CustomerID").equalTo(<?php echo $_actual_customer['CustomerID'] ?>).once("value", function(snapshot) {
							...
							$("div#sidebar-wrapper #totalOrdersCustomer").html(total_orders);
							$("div#sidebar-wrapper #totalEmergencyRepair").html(total_emergengy_orders);
							$("div#sidebar-wrapper #totalScheduleRepair").html(total_schedule_orders);
