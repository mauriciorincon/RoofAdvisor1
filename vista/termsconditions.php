...
<p>Effective as of May 15, 2018</p>
...
<p>This Website and the services of RoofServiceNow and RoofServicePro (collectively the "Services") are offered to you, conditioned on your acceptance without modification, of the following terms, conditions, and notices contained in this agreement (the "Terms and Conditions"). Your use of this Website or submission of service requests via telephone constitutes your agreement to all such terms, conditions, and notices in effect at such time. These Terms and Conditions apply to any Services or properties such as websites or apps owned and operated by Viaplix, LLC (including but not limited to RoofServiceNow.com, RAZ mobile customer application, RAZ PRO service professional mobile application, the Customer Dashboard website and app, the service professional Dashboard website and app, etc) and collectively referred to herein as "RoofServiceNow," on which a link to these Terms & Conditions appears. If you have any questions regarding these Terms & Conditions, you may contact us at www.RoofServiceNow.com. We may amend these Terms & Conditions at any time by posting a revised version of these Terms and Conditions. These Terms & Conditions were last updated on February 23th, 2018.</p>
...
<li><b>Scheduled Repair Services. </b> You can choose to schedule appointments with certain Service Professionals right in the RoofServiceNow website or mobile application. Please be aware that RoofServiceNow does not guarantee that the Service Professionals will be on time for, or show up for, any such booked appointments, as the Service Professionals are not the employees, contractors or agents of RoofServiceNow. RoofServiceNow is solely providing the platform to facilitate scheduling of appointments between you and the Service Professionals.	

</li>

<li><b>No Guarantees or Endorsements.</b>Although we take certain steps to examine the credentials of the Service Professionals listed on our website or whom you may book using our Services, we make no guarantees, warranties or representations regarding the skills or undertakings of such Service Professional or the quality of the job that he or she may perform for you if you elect to retain their services. RoofServiceNow does not endorse or recommend the services of any particular Service Professional. Except as set forth below in Paragraph 11 and Paragraph 12, we do not independently verify their representations about their services, nor validate any reviews. It is entirely up to you to evaluate the Service Professional and the Service Professional's qualifications, and to enter into a direct contract or otherwise reach agreement with a Service Professional. We do not guarantee or warrant any Service Professional's performance on the job or the outcome or quality of the services performed. The Service Professionals are not employees or agents of RoofServiceNow, nor is RoofServiceNow an agent of the Service Professionals.</li>

<li><b>No Contracting via the RoofServiceNow Website.</b> RoofServiceNow may inform you of certain offers or discounts provided by a Service Professional. Such offers or discounts are made solely by the Service Professional, and RoofServiceNow does not guarantee or warrant the pricing or discounts that a Service Professional may offer you. Any quotes provided by Service Professionals via the RoofServiceNow or apps, or which you find on the RoofServiceNow or apps, are not contractually binding offers, are for informational purposes only, and cannot be accepted on or via RoofServiceNow. No contractual arrangement is created based upon the quotes provided to you from Service Professionals (or your scheduling of an appointment with a Service Professional) via RoofServiceNow. To contract with a Service Professional, you must work directly with the Service Professional. RoofServiceNow does not perform, and is not responsible for, any of the Services requested by you in your service request. Your rights under contracts you enter into with Service Professionals are governed by the terms of such contracts and by applicable federal, state, provincial and local laws. RoofServiceNow is not a party to such agreements. All payments and applicable taxes must be made to the Service Professional in accordance with the agreements.</li>



<li><b>Release from Damages or Claims.</b> Should you have a dispute with respect to any services provided by a Service Professional or the fees charged by any Service Professional, you must address such dispute with the Service Professional directly (although you may copy RoofServiceNow on the fee disputes). YOU HEREBY AGREE TO RELEASE RoofServiceNow (AND OUR OFFICERS, DIRECTORS, SHAREHOLDERS, AFFILIATES, EMPLOYEES AND AGENTS) FROM ANY DAMAGES OR CLAIMS (INCLUDING CONSEQUENTIAL AND INCIDENTAL DAMAGES) OF EVERY KIND OR NATURE, SUSPECTED AND UNSUSPECTED, KNOWN AND UNKNOWN, AND DISCLOSED OR UNDISCLOSED, ARISING OUT OF OR IN ANY WAY CONNECTED WITH SUCH DISPUTES AND YOUR DEALINGS WITH SERVICE PROFESSIONALS.</li>
...
Upon using RoofServiceNow, you will be prompted to disclose certain information about yourself and your service requirements, and you will be able to store information, such as home services records, on our website or apps. Some of this information will be sent to Service Professionals who will need this information to respond to your request. By providing this information to us, or by submitting a service request, you are requesting, and you expressly consent to being contacted by us and by our Service Professionals via phone, fax, email, mail, text (SMS) messaging, or other reasonable means, at any of your contact numbers or addresses, even if you are listed on any federal, state, provincial or other applicable "Do Not Call" list, in order that we may provide the Services set forth on our site, to service your account, to reasonably address matters pertaining to your account, including but not limited to notifying you of, or confirming, appointments that you have scheduled, or for other purposes reasonably related to your service request and our business, including marketing related emails. You also authorize RoofServiceNow to send you an automated prerecorded call confirming your service request, along with calls from up to four service professionals that can help you with your request to the land-line or mobile phone number you provided, and you understand that either RoofServiceNow or the Service Professionals may use automated phone technology (including autodialed and prerecorded messages) to call you and that your consent is not required to purchase products or services. For complete details on our use of your information, please see our privacy statement. You agree that by completing a service request, you are entering into a business relationship with RoofServiceNow and/or a Service Professional and thus agree to be contacted by RoofServiceNow and/or a Service Professional. You promise that all information you provide (including but not limited to your contact information, and any Ratings and Reviews of Service Professionals that you provide) will be accurate, current and truthful to the best of your knowledge. If you provide any information that is untrue, not current or incomplete, or RoofServiceNow has reasonable grounds to suspect that such information is untrue, inaccurate, not current or incomplete, RoofServiceNow has the right to refuse any current or future use of the RoofServiceNow Services (or any portion thereof) by you. You are responsible for any use of the RoofServiceNow Services by persons to whom you intentionally or negligently allow access to your password.

<br>

TO KNOWINGLY INPUT FALSE INFORMATION, INCLUDING BUT NOT LIMITED TO NAME, PHONE NUMBER, ADDRESS OR E-MAIL ADDRESS IS A VERY SERIOUS AND FRAUDULENT MATTER THAT COULD RESULT IN SIGNIFICANT COSTS AND DAMAGES INCLUDING INVASION OF PRIVACY RIGHTS, TO RoofServiceNow AND THE SERVICE PROFESSIONALS, AND TO CONSUMERS, AS WELL AS THE LOSS OF TIME, EFFORT AND EXPENSE RESPONDING TO AND PURSUING SUCH FALSE INFORMATION AND REQUEST, AND FURTHER, COULD RESULT IN REGULATORY FINES AND PENALTIES. ACCORDINGLY, IF YOU KNOWINGLY INPUT FALSE INFORMATION IN A SERVICE REQUEST, INCLUDING BUT NOT LIMITED TO SOME ONE ELSE'S NAME, E-MAIL ADDRESS, PHYSICAL ADDRESS OR PHONE NUMBER OR A RANDOM OR MADE UP NAME, ADDRESS, E-MAIL OR PHONE NUMBER YOU AGREE TO FULLY INDEMNIFY AND BE LIABLE TO RoofServiceNow AND EACH SERVICE PROVIDER WHO ACCEPTS SUCH SERVICE REQUESTS, FOR THE GREATER OF: (1) A MINIMUM AMOUNT OF $11,000 TO EACH OF RoofServiceNow AND EACH OF THE AFFECTED SERVICE PROFESSIONALS AND FOR EACH OF THE ACTUAL PERSON(S) AFFECTED BY ANY OF THE IMPROPER, INCORRECT OR FRAUDULENT INFORMATION YOU ENTER (FOR EXAMPLE THE ACTUAL OWNER OF THE E-MAIL ADDRESS OR PHONE NUMBER, ETC.), PER IMPROPER SUBMISSION, PLUS ANY ATTORNEYS FEES COSTS AND EXPENSE RELATING THERETO, IF APPLICABLE, OR (2) THE ACTUAL DAMAGES, DIRECT, PUNITIVE AND CONSEQUENTIAL, AND ANY REGULATORY OR JUDICIAL FINES OR PENALTIES THAT MAY ARISE FROM SUCH INTENTIONAL, MISLEADING, HARMFUL AND FRAUDULENT ACTIVITY, PLUS REASONABLE LEGAL FEES, COST AND EXPENSES RELATING THERETO, WHICH EVER IS GREATER.
...
By submitting a service request, you agree that RoofServiceNow and the Service Professionals may send you informational text (SMS) messages as part of the normal business practice of RoofServiceNow. These text (SMS) messages shall not be used for marketing purposes. You may choose to opt-out of receiving text (SMS) messages from RoofServiceNow at any time by texting the word STOP to 89056 from the mobile device that is receiving the messages. You acknowledge that by opting out of receiving text (SMS) messages from RoofServiceNow and the Service Professionals, your use of RoofServiceNow Services may be impacted.
...
While we cannot guarantee the work performed by a listed Service Professional, and while we have no obligation to you with regard to your relationship with a Service Professional, the RoofServiceNow resolution process has been developed to try and assist you in resolving any disputes that may arise in the course of a home improvement repair or maintenance project with a Service Professional who you learned about through the RoofServiceNow Services. Without modifying our statements under this Agreement, we may, upon your request, provide limited assistance in resolving disputes between you and a Service Professional. You must participate and use good faith efforts to resolve problems through the RoofServiceNow resolution process. Such limited assistance in no way nullifies the release and indemnification described in these Terms & Conditions.
...
You agree that all of the content and information posted by you or your agents or designees on RoofServiceNow, including but not limited to:</p>
...
(known collectively as "Content") is the sole and exclusive property of RoofServiceNow, and that you have no right to reproduce, post, publish, or otherwise use such information other than for your personal use relating to your service request.</li>
...
<li><b>Grant of License.</b> You hereby grant RoofServiceNow and its users a perpetual, non-exclusive, royalty-free, transferable, assignable, sub-licensable, worldwide license to use, store, display, reproduce, modify, create derivative works, perform, distribute, print, publish, disseminate and place advertising near and adjacent to your Content in any format or media (whether now know or hereafter created) on the RoofServiceNow and apps in any manner that we deem appropriate or necessary, including, if submitted, your name, voice and likeness throughout the world, and such permission shall be perpetual and cannot be revoked for any reason.

</li> 

<li><b>Representation of Ownership and Right to Use Content.</b> By posting or providing any Content to RoofServiceNow, you represent and warrant to RoofServiceNow that you own or have all necessary rights to use the Content, and grant to RoofServiceNow the rights granted below. The forgoing representation includes, but is not limited to a representation and warranty that you own or have the necessary rights (including any necessary releases) to grant all rights granted below in relation to any persons, places or intellectual property pictured in any photographic Content that you provide. In addition, if you post or otherwise provide any Content that is protected by copyright, you represent that you have obtained any necessary permissions or releases from the applicable copyright owner.</li> 

<li><b>Content Guidelines.</b> RoofServiceNow reserves the right, but not the obligation, to edit or abridge, or to refuse to post, or to remove any content that you or any other users post on any RoofServiceNow owned or operated websites or apps if RoofServiceNow determines (in its sole discretion) that such content contains or features any of the following:</li>
...
<li>Comments that disparage RoofServiceNow.</li>
...
<tr><td> RoofServiceNow Star Rating</td></tr>
...
<b>Identity Verification (Social Security Number)</b> - RoofServiceNow verifies the social security numbers of business owners/principals to confirm their identities. (This applies primarily to small businesses.)

</li>



<li><b>Legal Search for Civil Judgments </b>- We use third party data sources to check, within the 12 months prior to the service professional?s application for membership in the RoofServiceNow network, for significant state-level civil legal judgments or liens entered against the owner/principal by business customers and for bankruptcy filings by or against the owner/principal, in the state in which the owner/principal of the company is located.<br>
...
Corporate Accounts: Some Service Professionals are employees, franchisees, dealers, or independent contractors ("Corporate SP's") of larger national or corporate accounts ("Corporate Accounts"). In such event, you may be matched with the Corporate Account entity or with one of their Corporate SP's. The above screening criteria is not applicable to Corporate Accounts, and therefore, RoofServiceNow does not screen the Corporate Accounts or Corporate SP's.

<br>

Service Professionals Profiles: RoofServiceNow allows Service Professionals to post profiles about themselves and their business on the RoofServiceNow or apps. RoofServiceNow does not review or verify the information or representations set forth in those profiles, except as expressly set forth above, as they are self-reported by the Service Professional. RoofServiceNow therefore makes no representations or warranties regarding any information posted by a Service Professional, and assumes no liability for such information.

<br>

The above procedures may change from time to time at the sole discretion of RoofServiceNow. RoofServiceNow believes that it uses commercially reasonable methods to check these matters but does not make any representations or warranties that members continue to meet the above screening criteria after the date of their enrollment in the RoofServiceNow network. RoofServiceNow does not represent or warrant that the information received from state, provincial or other government agencies or from third party sources is accurate, error free, or that it is up to date or updated at the time that RoofServiceNow checks such information. Most agencies have periodic update cycles or schedules and this information is not updated on a real-time basis by such agencies and third party sources.
...
While we will not match you with a service professional from our affiliates, we may display to you service professionals from affiliates, including but not limited to Angie's List. These service professionals have NOT been screened by RoofServiceNow using the screening set forth in Section 11. Rather, these service professionals have been screened as follows:<br>

RoofServiceNow will only display Angie's List Service professionals that
...
<h4>13.ARTICLES AND OTHER CONTENT</h4>

<p>

RoofServiceNow provides certain content relating to home improvement, repair, maintenance ("Articles"), on the RoofServiceNow or apps, and via mobile applications owned and operated by RoofServiceNow. Such Articles are provided "As-Is", without any warranties or representations, and you assume all liability and responsibility for your use of such Articles. You understand and agree that the Articles do not provide advice, and that such Articles are no substitute for the advice of a professional.	
...
The links in the RoofServiceNow or apps will let you leave RoofServiceNow's Web site. The linked sites are not under the control of RoofServiceNow and RoofServiceNow is not responsible for the contents or functionality of any linked site or any link contained in a linked site, or any changes or updates to such sites. Your use of such third party linked sites is governed by the terms and conditions, and privacy policies, of such linked sites. RoofServiceNow is not responsible for webcasting or any other form of transmission received from any linked site. RoofServiceNow is providing these links to you only as a convenience, and the inclusion of any link does not imply endorsement by RoofServiceNow of the site.
...
RoofServiceNow respects the intellectual property rights of others.

</p>

<h4>NOTICE SPECIFIC TO DOCUMENTS AND INFORMATION AVAILABLE ON THIS WEBSITE.</h4>
...
<li>The exclusive means of resolving any dispute between you and RoofServiceNow or any claim made by you or RoofServiceNow arising out of or relating to your use of this Website and/or RoofServiceNow's services (including any alleged breach of these Terms and Conditions) shall be BINDING ARBITRATION administered by the American Arbitration Association. The one exception to the exclusivity of arbitration is that you have the right to bring an individual claim against RoofServiceNow in a small-claims court of competent jurisdiction OR EXCEPT AS EXPRESSLY PROVIDED BY APPLICABLE FEDERAL OR STATE LAW. But whether you choose arbitration or small-claims court, you may not under any circumstances commence or maintain against RoofServiceNow any class action, class arbitration, or other representative action or proceeding.</li>
...
<li>By using the Website and/or RoofServiceNow's services in any manner, you agree to the above arbitration agreement. In doing so, YOU GIVE UP YOUR RIGHT TO GO TO COURT to assert or defend any claims between you and RoofServiceNow (except for matters that may be taken to small-claims court). YOU ALSO GIVE UP YOUR RIGHT TO PARTICIPATE IN A CLASS ACTION OR OTHER CLASS PROCEEDING. Your rights will be determined by a NEUTRAL ARBITRATOR, NOT A JUDGE OR JURY. You are entitled to a fair hearing before the arbitrator. The arbitrator can grant any relief that a court can, but you should note that arbitration proceedings are usually simpler and more streamlined than trials and other judicial proceedings. Decisions by the arbitrator are enforceable in court and may be overturned by a court only for very limited reasons. For details on the arbitration process, see our Arbitration Procedures.

</li>

<li>Any proceeding to enforce this arbitration provision, including any proceeding to confirm, modify, or vacate an arbitration award, may be commenced in any court of competent jurisdiction. In the event that this arbitration provision is for any reason held to be unenforceable, any litigation against RoofServiceNow (except for small-claims court actions) may be commenced only in the federal or state courts located in Denver County, Colorado. You hereby irrevocably consent to the jurisdiction of those courts for such purposes.

</li>

<li>These Terms and Conditions, and any dispute between you and RoofServiceNow, shall be governed by the laws of the state of Colorado without regard to principles of conflicts of law, provided that this arbitration agreement shall be governed by the Federal Arbitration Act.
...
You acknowledge and agree that the RoofServiceNow Services are provided to you on an "AS IS" basis without any warranty whatsoever, and your sole and exclusive remedy, and RoofServiceNow's sole obligation to you or any third party for any claim arising out of your use of the RoofServiceNow Services or the RoofServiceNow or apps, is that you are free to discontinue your use of the RoofServiceNow Services or the RoofServiceNow or apps at any time. EXCEPT AS EXPRESSLY SET FORTH HEREIN, RoofServiceNow EXPRESSLY DISCLAIMS ANY IMPLIED WARRANTIES OF ANY KIND, INCLUDING, BUT NOT LIMITED TO, WARRANTIES OF MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE, AND YOU AGREE THAT RoofServiceNow SHALL HAVE NO LIABILITY FOR DIRECT, INDIRECT, SPECIAL, INCIDENTAL, CONSEQUENTIAL (INCLUDING LOST PROFIT), EXEMPLARY OR PUNITIVE DAMAGES (EVEN IF RoofServiceNow HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES) ARISING OUT OF THIS AGREEMENT OR ANY CONSEQUENCES WHICH FLOW FROM IT. SOME STATES AND PROVINCES DO NOT ALLOW LIMITATIONS ON OR EXCLUSION OF INCIDENTAL OR CONSEQUENTIAL DAMAGES. IN SUCH STATES AND PROVINCES, THE ABOVE EXCLUSIONS MAY NOT APPLY TO YOU. The Terms and Conditions will inure to the benefit of RoofServiceNow's successors, assigns and licensees. If any provision of these Terms and Conditions shall be deemed unlawful, void or unenforceable, for any reason, by any court of competent jurisdiction that provision shall be modified in order to make it enforceable, while maintaining the spirit of the provision. Alternatively, if modification is not possible, such provision shall be stricken and shall not affect the validity and enforceability of the remaining terms. The failure of RoofServiceNow to exercise or enforce any right or provision of the Terms and Conditions shall not constitute a waiver of such right or provision. You agree that regardless of any statute or law to the contrary, any claim or cause of action arising out of or related to use of the Services or the Terms and Conditions must be filed within one (1) year after such claim or cause of action arose or be forever barred. The section titles in the Terms and Conditions are for convenience only and have no legal or contractual effect. These Terms and Conditions are governed by the laws of the State of Colorado as such laws are applied to agreements entered into and to be performed entirely in the State of Colorado and between Colorado residents. You agree to submit to jurisdiction in Colorado and that any claim arising out of or related to these Terms and Conditions will be brought solely in a court in Denver County, Colorado. These Terms and Conditions constitute the entire agreement between you and RoofServiceNow and supersede all oral and written negotiations or representations of the parties with respect to the subject matter hereof. These Terms and Conditions may not be modified or amended other than by an agreement signed by both parties.
